...
import '../services/remboursement_calculator.dart';
...
class _SoinDetailScreenState extends State<SoinDetailScreen> {
  ...
  Future<void> _checkProfilAndLoadData() async {
    try {
      ...
      final userInfoResponse = await _supabase
          .from('user_infos')
          .select('mutuelle_id, mutuelle_formule_id, regime_assurance_maladie_id, date_of_birth')
          .eq('user_id', userId)
          .maybeSingle();
  ...
  void _calculerRemboursements() {
    ...
    // Créer l'objet RemboursementInfo
  ...
  Widget build(BuildContext context) {
    ...
    if (!_profilComplet) {
      return _buildProfilIncompletScreen();
    }
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  '${_result!.pourcentagePriseEnCharge.toStringAsFixed(0)}% remboursé',
                  style: const TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
                    color: Colors.white,
          ...
          _buildResultRow(
            ...
            '${_result!.remboursementSecu.toStringAsFixed(2)}€',
            false,
          ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    '-${_result!.participationForfaitaire.toStringAsFixed(2)}€',
                    style: const TextStyle(
                      fontSize: 12,
                      fontStyle: FontStyle.italic,
                      color: Colors.white70,
          ...
          _buildResultRow(
            _getLabelMutuelle(),
            '${_result!.remboursementMutuelle.toStringAsFixed(2)}€',
            false,
          ),
          ...
          _buildResultRow(
            'TOTAL REMBOURSÉ',
            '${_result!.totalRembourse.toStringAsFixed(2)}€',
            true,
          ),
          const SizedBox(height: 20),
          _buildResteAChargeBox(),
          if (_result!.resteACharge == 0) ...[
            const SizedBox(height: 16),
            _buildEntierementPrisEnCharge(),
          ],
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            '${_result!.resteACharge.toStringAsFixed(2)}€',
            style: const TextStyle(
              fontSize: 24,
              fontWeight: FontWeight.w700,
              color: Colors.white,
  ...
  Widget _buildEntierementPrisEnCharge() {
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        color: Colors.white.withOpacity(0.2),
            ...
            Column(
              ...
              children: [
                ...
                _buildDefinitionItem(
                  '⚠️',
                  'Participation forfaitaire',
                  '1€ déduit par consultation (si majeur)',
                  'La Sécurité sociale déduit 1€ par consultation ou acte médical '
                      'pour les personnes majeures (≥18 ans). '
                      'Cette déduction est automatiquement prise en compte dans le calcul.',
                ),
